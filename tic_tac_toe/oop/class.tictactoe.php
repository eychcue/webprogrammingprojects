...
class tictactoe extends game
{
	...
	**/
	...
	// function getPlayerXW(){
	// 	return $this->$playerXW;
	// }

	// function setPlayerXW(){
	// 	return $this->$playerXW++;
	// }

	// function getPlayerYW(){
	// 	return $this->$playerYW;
	// }

	// function setPlayerYW(){
	// 	return $this->$playerYW++;
	// }
	...
	function displayGame()
	{
		...
		else
		{
			...
			if ($this->isOver() != "Tie"){
				...
				{
				$_SESSION["scorep1"]++;
					echo ($_SESSION["scorep1"]);
					echo ($_SESSION["scorep2"]);
				}
				else {
					$_SESSION["scorep2"]++;
					echo ($_SESSION["scorep1"]);
